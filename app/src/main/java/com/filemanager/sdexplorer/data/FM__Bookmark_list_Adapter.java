...
public class FM__Bookmark_list_Adapter extends BaseAdapter{


	private Activity activity;
	private ArrayList<FM_Bookmark_Data> bookmarklist;
	private LayoutInflater inflater=null;
	private ImageThreadLoader imageLoader;
	private DrawableThreadLoader	drawableLoader;
	private boolean thumbnail_flag = true;
	public FM__Bookmark_list_Adapter(FM_bookmarkList fm_bookmarkList,
			ArrayList<FM_Bookmark_Data> favuserlist) {
		// TODO Auto-generated constructor stub
		activity=fm_bookmarkList;
		bookmarklist=favuserlist;
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		txtbookmarkname.setText(bookmarklist.get(position).getBookmark_name());
		txtbookmarkpath.setText(bookmarklist.get(position).getBookmark_path());

		String	sub_ext=bookmarklist.get(position).getBookmark_file_type();
		File file = new File(bookmarklist.get(position).getBookmark_path());
				...
				sub_ext.equalsIgnoreCase("tiff")) 
		{
			...
			{
				image.setTag(bookmarklist.get(position).getBookmark_path());

				imageLoader.displayImage(bookmarklist.get(position).getBookmark_path(),activity, image);
