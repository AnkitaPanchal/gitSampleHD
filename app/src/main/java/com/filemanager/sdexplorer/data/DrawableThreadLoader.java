...
public class DrawableThreadLoader {
   ...
   final int stub_id =R.drawable.apk;
   ...
   public void CreateCacheFile(Bitmap bmp,String url){
   	...
   	try{
   	File img = new File(android.os.Environment.getExternalStorageDirectory()+"/File Manager/cache_img/"+String.valueOf(url.hashCode()));
